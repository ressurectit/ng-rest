...
import {RestMiddleware, RestResponseTransform} from '../interfaces';
import type {RESTClientBase} from '../misc/classes/restClientBase';

/**
 * Middleware that is used for adding support of response transform
 */
export class ResponseTransformMiddleware implements RestMiddleware<unknown, unknown, RestResponseTransform>
{
